...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_plan_reg=dict(type='L1Loss', loss_weight=1.0),  # NOTE
        ...
        loss_corridor_bound=dict(type='CorridorMapBoundLoss',loss_weight=1.0),
        loss_corridor_col=dict(type='CorridorCollisionLoss',loss_weight=1.0),
        loss_corridor_area=dict(type='CorridorAreaLoss', loss_weight=1.0),
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs',
               'ego_fut_trajs', 'ego_fut_masks', 'ego_fut_cmd', 'ego_lcf_feat', 'gt_attr_labels', 'gt_corridor'])
]
        ...
        transforms=[
            ...
            dict(type='CustomCollect3D',\
                 keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'img', 'fut_valid_flag',
                       ...
                       'ego_lcf_feat', 'gt_attr_labels', 'gt_corridor'])])
]
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'corridor_nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             pc_range=point_cloud_range,
             ann_file=data_root + 'corridor_nuscenes_infos_temporal_val.pkl',
