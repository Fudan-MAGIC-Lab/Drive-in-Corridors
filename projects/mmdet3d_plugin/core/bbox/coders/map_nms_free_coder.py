...
class MapNMSFreeCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, pts_preds, corr_preds, corr_clipped):
        """Decode bboxes.
        Args:
        ...
        final_corr_preds = corr_preds
        final_corr_clliped = corr_clipped
        ...
        if self.post_center_range is not None:
            ...
            predictions_dict = {
                ...
                'map_labels': labels,
                'map_pts': pts,
                'corridor_pts': final_corr_preds,
                'corridor_clip': final_corr_clliped,
            }
    ...
    def decode(self, preds_dicts):
        ...
        all_corr_preds = preds_dicts['ego_cor_preds']
        all_corr_clipped = preds_dicts['clipped_cor']
        batch_size = all_cls_scores.size()[0]
        predictions_list = []
        for i in range(batch_size):
            predictions_list.append(self.decode_single(all_cls_scores[i], all_bbox_preds[i],all_pts_preds[i], all_corr_preds, all_corr_clipped))
