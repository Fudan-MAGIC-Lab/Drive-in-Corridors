...
class CustomNuscenesBox:
    ...
    def render_fut_trajs_grad_color(self,
        ...
        if mode_idx is not None:
            ...
            # fut_coords = fut_coords[[mode_idx]] # https://github.com/hustvl/VAD/issues/19
        ...
        for i in range(fut_coords.shape[0]):
            ...
            line_segments = LineCollection(fut_vecs, colors=colors, linewidths=linewidth, linestyles=linestyles, cmap=cmap, alpha=alpha)
